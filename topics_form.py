...
class TopicsWindow(QMainWindow):
    def __init__(self, flashcard_app):
        ...
        self.topics_list.setAccessibleDescription ('list of topics')
        ...
        self.terms_list.setAccessibleDescription ('list of turms')
